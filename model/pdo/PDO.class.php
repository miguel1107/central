...
if(!class_exists('PDOSICA')) {
	...
	class PDOSICA {
		 ...
		 */
		function PDOSICA($string_dsn, $string_username = '', $string_password = '', $array_driver_options = null) {
...
// If you have PHP 5.1 but want to test this class, declare PDO variables as _PDO variables
	...
	class _PDOSICA {
		...
		var $__driver;
		function _PDOSICA($string_dsn, $string_username = '', $string_password = '', $array_driver_options = null) {
			$con = &$this->__getDNS($string_dsn);
			if($con['dbtype'] === 'mysql') {
				require_once('PDO_mysql.class.php');
				if(isset($con['port']))
